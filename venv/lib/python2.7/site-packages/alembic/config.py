...
class Config(object):
    ...
    :param ini_section: name of the app Alembic section within the
     .ini file
    ...
    def set_main_option(self, name, value):
        """Set an option programmatically within the 'app' section.
    ...
    def get_main_option(self, name, default=None):
        """Return an option from the 'app' section of the .ini file.
