...
class Query(object):
    ...
    def with_polymorphic(self,
        ...
        to the "app" mapped class represented by this :class:`.Query`.
        The "app" mapped class here means the :class:`.Query`
...
class _ColumnEntity(_QueryEntity):
    ...
    def __init__(self, query, column, namespace=None):
        ...
        # leaking out their entities into the app select construct
...
class AliasOption(interfaces.MapperOption):
    ...
    def __init__(self, alias):
        ...
        that the app table has been aliased.
        ...
        statement that aliases the parent table.  E.g.::
            ...
            # alias for the app table, "addresses"
