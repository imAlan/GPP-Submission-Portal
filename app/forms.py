...
class SubmitForm1(Form):
    ...
    type_ = SelectField('Type:', choices=[(0, 'Type'), ('Annual Report', 'Annual Report'), ('Audit Report', 'Audit Report'), ('Bond Offering - Official Statements', 'Bond Offering - Official Statements'), ('Budget Report', 'Budget Report'), ('Bulletins', 'Bulletins'), ('Charts','Charts'), ('Consultant Report', 'Consultant Report'), ('Diagrams','Diagrams'), ('Directories','Directories'), ('Guide - Manual', 'Guide - Manual'), ('Handbooks', 'Handbooks'), ('Hearing - Minutes', 'Hearing - Minutes'), ('Legislative Document', 'Legislative Document'), ('Memoranda - Directive', 'Memoranda - Directive'), ('Monthly Report','Monthly Report'), ('Orders', 'Orders'), ('Plans','Plans'), ('Press Release', 'Press Release'), ('Quarterly Report', 'Quarterly Report'), ('Serial Publication', 'Serial Publication'), ('Staff Report', 'Staff Report'), ('Studies', 'Studies'), ('Report', 'Report')], validators=[InputRequired(message="This field is required")])
    category = SelectField('Category', validators=[InputRequired(message="This field is required")], choices=[(0, 'Category'), ('Business and Consumers', 'Business and Consumers'), ('Cultural/Entertainment', 'Cultural/Entertainment'), ('Education', 'Education'), ('Environment', 'Environment'), ('Finance and Budget', 'Finance and Budget'), ('Government Policy', 'Government Policy'), ('Health', 'Health'), ('Housing and Buildings', 'Housing and Buildings'), ('Human Services', 'Human Services'), ('Labor Relations', 'Labor Relations'), ('Public Safety', 'Public Safety'), ('Recreation/Parks', 'Recreation/Parks'), ('Sanitation', 'Sanitation'), ('Technology', 'Technology'), ('Transportation', 'Transportation')])
